...
def load_silver_transactions(spark, catalog, schema,
    ...
    USING (SELECT f.is_fraud, t.* EXCEPT(countryOrig, countryDest, t._rescued_data), 
         ...
         to_number(newBalanceOrig, '999999.99') - to_number(oldBalanceOrig, '999999.99') as diffOrig, 
         to_number(newBalanceDest, '999999.99') - to_number(oldBalanceDest, '999999.99') as diffDest
